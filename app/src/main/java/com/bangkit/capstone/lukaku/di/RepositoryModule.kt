...
import com.bangkit.capstone.lukaku.data.repository.drugstore.DrugstoreRepositoryImpl
...
abstract class RepositoryModule {
    ...
    @Binds
    abstract fun bindsDrugstoreRepository(drugstoreRepositoryImpl: DrugstoreRepositoryImpl): DrugstoreRepository
}